...
class nisqaModel:
    ...
    args: ArgsDict
    runinfos: dict[str, Any]
    dev: torch.device
    model: nn.Module
    model_args: ArgsDict

    def __init__(self, args: ArgsDict) -> None:
        self.args = args
    ...
    def evaluate(self, mapping: str | None = "first_order", do_print: bool = True, do_plot: bool = False) -> None:
        if self.args["dim"]:
    ...
    def predict(self) -> pd.DataFrame:
        ...
        if self.args["dim"]:
            y_val_hat, y_val = NL.predict_dim(
                self.model, self.ds_val, self.args["tr_bs_val"], self.dev, num_workers=self.args["tr_num_workers"]
            )
        else:
        ...
        if self.args["output_dir"]:
            ...
            self.ds_val.df.to_csv(os.path.join(self.args["output_dir"], "NISQA_results.csv"), index=False)

        print(self.ds_val.df.to_string(index=False))
        return self.ds_val.df

    def _train_mos(self) -> None:
        """
        ...
        scheduler = optim.lr_scheduler.ReduceLROnPlateau(
            opt, "min", verbose=True, threshold=0.003, patience=self.args["tr_lr_patience"]
        )
        ...
        # Training done --------------------------------------------------------
        print("--> Training done. best_r_p {:0.2f} best_rmse_map {:0.2f}".format(earlyStp.best_r_p, earlyStp.best_rmse))
        return

    def _train_dim(self) -> None:
        """
        ...
        # Training done --------------------------------------------------------
        print("--> Training done. best_r_p {:0.2f} best_rmse {:0.2f}".format(earlyStp.best_r_p, earlyStp.best_rmse))
        return

    def _evaluate_mos(self, mapping: str | None = "first_order", do_print: bool = True, do_plot: bool = False) -> None:
        """
        ...
        if self.ds_val.df_con is None:
            ...
            print(
                "r_p_mean_con: {:0.2f}, rmse_mean_con: {:0.2f}, rmse_star_map_mean_con: {:0.2f}".format(
                    self.r["r_p_mean_con"], self.r["rmse_mean_con"], self.r["rmse_star_map_mean_con"]
                )
            )

    def _evaluate_dim(self, mapping: str | None = "first_order", do_print: bool = True, do_plot: bool = False) -> None:
        """
        ...
        if self.ds_val.df_con is None:
            ...
            print(
                "r_p_mean_con: {:0.2f}, rmse_mean_con: {:0.2f}, rmse_star_map_mean_con: {:0.2f}".format(
                    r_val_mos["r_p_mean_con"], r_val_mos["rmse_mean_con"], r_val_mos["rmse_star_map_mean_con"]
                )
            )
        ...
        if self.ds_val.df_con is None:
            ...
            print(
                "r_p_mean_con: {:0.2f}, rmse_mean_con: {:0.2f}, rmse_star_map_mean_con: {:0.2f}".format(
                    r_val_dis["r_p_mean_con"], r_val_dis["rmse_mean_con"], r_val_dis["rmse_star_map_mean_con"]
                )
            )
        r_val_dis = {k + "_dis": v for k, v in r_val_dis.items()}
        ...
        if self.ds_val.df_con is None:
            ...
            print(
                "r_p_mean_con: {:0.2f}, rmse_mean_con: {:0.2f}, rmse_star_map_mean_con: {:0.2f}".format(
                    r_val_col["r_p_mean_con"], r_val_col["rmse_mean_con"], r_val_col["rmse_star_map_mean_con"]
                )
            )
        r_val_col = {k + "_col": v for k, v in r_val_col.items()}
        ...
        if self.ds_val.df_con is None:
            ...
            print(
                "r_p_mean_con: {:0.2f}, rmse_mean_con: {:0.2f}, rmse_star_map_mean_con: {:0.2f}".format(
                    r_val_loud["r_p_mean_con"], r_val_loud["rmse_mean_con"], r_val_loud["rmse_star_map_mean_con"]
                )
            )
        r_val_loud = {k + "_loud": v for k, v in r_val_loud.items()}
    ...
    def _makeRunnameAndWriteYAML(self) -> str:
        """
    ...
    def _loadDatasetsFolder(self) -> None:
    ...
    def _loadDatasetsFile(self) -> None:
    ...
    def _loadDatasetsCSVpredict(self) -> None:
        """
    ...
    def _loadDatasetsCSV(self) -> None:
        """
    ...
    def _getDevice(self) -> None:
        ...
        if self.args.get("tr_parallel") and self.dev == torch.device("cpu"):
